...
declare class Block extends BlockCore {
     ...
     * @memberof Block
     */
    constrainTo(block: any, options?: object): Matter.Constraint;
    /**
     * Remove a constraint of this block to another block.
     * @param {contraint} constraint
     * @memberof Block
     */
    removeConstraint(contraint: any): void;
    /**
...
declare class BlockCore {
     ...
     */
    constructor(world: Matter.World, attributes: IBlockCoreAttributes, options?: Matter.IChamferableBodyDefinition);
    /** @type {Matter.World} */ world: Matter.World;
    /** @type {IBlockCoreAttributes} */ attributes: IBlockCoreAttributes;
    /** @type {Matter.IChamferableBodyDefinition} */ options: Matter.IChamferableBodyDefinition;
    addBody(): void;
    body: Matter.Body;
    /**
     ...
     */
    drawVertices(vertices: (IVertex | Matter.Vertex)[]): void;
}
type Color = import("../node_modules/@types/p5/index").Color;
type IVertex = {
    x: number;
    y: number;
    z?: number;
...
type IFill = string | number[] | Color | any;
type IStroke = IFill;
type IBlockCoreAttributes = {
    x: number;
    y: number;
    w: number;
    h: number;
