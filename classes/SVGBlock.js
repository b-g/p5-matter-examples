...
let block = new SVGBlock({ x: 300, y: 500, elem: 'puzzle', scale: 0.6, color: 'lime' }, { isStatic: true, friction: 0.0 }));
// SVG in separate file path defined via file attribute
let block = blocks.push(new SVGBlock(world, { x: 580, y: 710, file: './path.svg', scale: 0.6, color: 'yellow' }, { isStatic: true, friction: 0.0 }));
*/
